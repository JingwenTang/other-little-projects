...
if nargout
  ...
  client_id = '771935929905-38u0m9mqk0ja8flesj50v27m55f5ados.apps.googleusercontent.com';
    client_secret = 'YRz0UEdtSRYXoevGWom9WKso';
...
% A basic online game where player 2 tries to guess what player 1 number is
% if player 2 guesses the number correctly, player 2 win. Otherwise, player
% 1 win

    %google API credentials and spreadSheet link 
